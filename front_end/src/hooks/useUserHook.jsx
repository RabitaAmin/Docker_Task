...
const UseUserHook = () => {
    ...
    const deleteRev = async (bookId) => {
        try {
            const resp = await axiosInstance.delete(`/user/deleteReview?bookId=${bookId}`)
            console.log(resp);
            return resp;
    ...
    return { balanceAdd, balance, setBalance, addReview, reviewInfo, setReviewInfo, getAllTransaction, setTransaction, transaction, fetchProductReviewById, userProfile, fetchReview, getBookById, addRev, updateRev, deleteRev }
}
