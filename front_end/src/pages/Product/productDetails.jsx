...
const ProductDetails = () => {
    const { fetchReview, getBookById, addRev, updateRev, deleteRev } = UseUserHook();
    ...
    console.log(rating)
    const deleteReview = () => {
        const revDelete = async (revDelete) => {
            try {
                const response = await deleteRev(productId)
                console.log(response.data);
                if (response.data.success) {
                    setDelReview(response.data);
                    toast(response.data.message);
                    navigate("/product");
                }
                else {
